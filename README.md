...
VideoPlayer for the React Native `<Video/>` component at [@lunarr/vlc-player][15].

[![demogif][16]][17]

## ⭐️ Features

This package contains a simple set of GUI controls that work with the [@lunarr/vlc-player][15] `<Video>` component.
...
[15]: https://github.com/lunarr-app/vlc-player
